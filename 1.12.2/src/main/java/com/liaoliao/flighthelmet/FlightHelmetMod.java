...
@Mod(modid = FlightHelmetMod.MOD_ID, name = "PigThings", version = FlightHelmetMod.VERSION,
        acceptedMinecraftVersions = "[1.12,1.13)", dependencies = "required-after:baubles;after:enderio")
public final class FlightHelmetMod {
    ...
    public static Item TRAPPED_PIGLIN_REMAINS;
    public static final net.minecraft.potion.Potion GHOST = new GhostPotion();
    ...
    public static final class Registration {
        ...
        @SubscribeEvent
        public static void registerPotions(RegistryEvent.Register<net.minecraft.potion.Potion> event) {
        ...
        public static void registerItems(RegistryEvent.Register<Item> event) {
            ...
            CARROT_SABER = net.minecraftforge.fml.common.Loader.isModLoaded("enderio")
                    ? com.liaoliao.flighthelmet.compat.EnderIoIntegration.createSaber() : new CarrotSaberItem();
            CARROT_SABER.setRegistryName(MOD_ID, "carrot_saber")
                    .setTranslationKey(MOD_ID + ".carrot_saber")
                    .setCreativeTab(CreativeTabs.COMBAT);
            IForgeRegistry<Item> registry = event.getRegistry();
            TRAPPED_PIGLIN_REMAINS = new TrappedPiglinRemainsItem();
            registry.registerAll(FLIGHT_HELMET, NICE_RING, NICE_PICKAXE, PIG_INGOT, CARROT_SABER, TRAPPED_PIGLIN_REMAINS);
        }
    }
    ...
    public static final class ClientRegistration {
        ...
        public static void registerModels(net.minecraftforge.client.event.ModelRegistryEvent event) {
            net.minecraftforge.client.model.obj.OBJLoader.INSTANCE.addDomain(MOD_ID);
            net.minecraftforge.client.model.ModelLoader.setCustomModelResourceLocation(TRAPPED_PIGLIN_REMAINS, 0,
                    new net.minecraft.client.renderer.block.model.ModelResourceLocation(MOD_ID + ":trapped_piglin_remains", "inventory"));
