...
public final class FlightHelmetMod {
    ...
    public static final RegistryObject<net.minecraft.world.effect.MobEffect> GHOST =
            EFFECTS.register("ghost", GhostEffect::new);
    public static final RegistryObject<Item> TRAPPED_PIGLIN_REMAINS = ITEMS.register("trapped_piglin_remains",
            () -> new TrappedPiglinRemainsItem(new Item.Properties().stacksTo(1)));
    ...
    public FlightHelmetMod() {
        ...
        ModNetwork.register();
        com.liaoliao.flighthelmet.network.AbilityNetwork.register();
    ...
    private void addCreativeTabContents(BuildCreativeModeTabContentsEvent event) {
        if (event.getTabKey().equals(CreativeModeTabs.TOOLS_AND_UTILITIES)) {
            ...
            event.accept(TRAPPED_PIGLIN_REMAINS);
    ...
    static {
        ...
        CARROT_SABER = ITEMS.register("carrot_saber",
                () -> new CarrotSaberItem(new Item.Properties().stacksTo(1)));
    }
}
