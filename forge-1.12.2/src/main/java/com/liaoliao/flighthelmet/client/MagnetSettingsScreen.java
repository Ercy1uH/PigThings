...
public final class MagnetSettingsScreen extends GuiScreen {
    private final FlightHelmetScreen parent;
    ...
    public MagnetSettingsScreen(FlightHelmetScreen parent, boolean magnetEnabled, int rangeX, int rangeY, int rangeZ) {
        this.parent = parent;
